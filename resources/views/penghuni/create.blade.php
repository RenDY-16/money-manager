...
<div class="breadcrumb-nav">
    ...
    <span class="breadcrumb-sep">/</span>
    <span class="breadcrumb-current">Tambah Penghuni</span>
</div>
...
<div class="form-card animate-in">
    ...
    <form action="{{ route('penghuni.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="no_hp" class="form-control" value="{{ old('no_hp') }}" placeholder="Contoh: 081234567890" inputmode="numeric" pattern="[0-9]+" required oninvalid="this.setCustomValidity('Nomor telepon hanya boleh berisi angka.')" oninput="this.setCustomValidity('')">
        </div>
        <div class="mb-3">
