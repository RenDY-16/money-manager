...
<body>
    <nav class="landing-nav">
        <a class="brand" href="<?php echo e(route('landing')); ?>">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo Kost AJ Lanraki">
            <div>
        ...
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="btn-dashboard"><i class="bi bi-speedometer2"></i> Dashboard</a>
        <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="btn-login"><i class="bi bi-box-arrow-in-right"></i> Login Admin</a>
        <?php endif; ?>
    </nav>
    ...
    <section class="hero">
        <div>
            ...
            <div class="hero-actions">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-login"><i class="bi bi-grid-1x2-fill"></i> Masuk Dashboard</a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-login"><i class="bi bi-lock-fill"></i> Login Admin</a>
                <?php endif; ?>
...
<?php /**PATH D:\TUBES-RPL\kost-aj\money-manager\resources\views/landing.blade.php ENDPATH**/ ?>